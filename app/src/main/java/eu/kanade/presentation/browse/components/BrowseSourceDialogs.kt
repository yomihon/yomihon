...
fun SavedSearchDeleteDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(text = stringResource(MR.strings.save_search_delete))
        },
        text = {
            Text(text = stringResource(MR.strings.save_search_delete_message, name))
        },
    )
}
...
fun SavedSearchCreateDialog(
    ...
    AlertDialog(
        onDismissRequest = onDismissRequest,
        title = { Text(text = stringResource(MR.strings.save_search)) },
        text = {
            OutlinedTextField(
                ...
                placeholder = {
                    Text(text = stringResource(MR.strings.save_search_hint))
                },
            )
        },
            ...
            TextButton(
                onClick = {
                    ...
                    if (searchName.isNotBlank() && searchName !in currentSavedSearches) {
                        ...
                        context.toast(MR.strings.save_search_invalid_name)
                    }
                },
            ) {
                Text(text = stringResource(MR.strings.action_ok))
